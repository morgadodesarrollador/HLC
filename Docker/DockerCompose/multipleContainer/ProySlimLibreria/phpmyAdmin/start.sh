...
config_slim(){
    ...
    mkdir -p ${PROYECTO}/api${PROYECTO} 
    cd /var/www/html/${PROYECTO}/api${PROYECTO}
    composer require slim/slim:"3.*"
    #chgrp -R www-data "/var/www/html/${PROYECTO}/api${PROYECTO}"
    chgrp -R www-data "/var/www/html/"
    #chmod g+w -R "/var/www/html/${PROYECTO}/api${PROYECTO}"
...
config_vhost(){
    ...
    echo "DocumentRoot /var/www/html/${PROYECTO}/api${PROYECTO}" >> ${PROYECTO}.conf
    echo "ServerName ${PROYECTO}.${DOMINIO}" >> ${PROYECTO}.conf
    echo "<Directory /var/www/html/${PROYECTO}/api${PROYECTO}>" >> ${PROYECTO}.conf
